    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="http://localhost:8080/pages/addblog">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form class="row g-3" method="POST" action="http://localhost:8080/pages/addblog">
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label">Blog Name</label>
                        <input type="text" class="form-control" name="bname" id="inputEmail4">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Blog Description</label>
                        <textarea rows="4" cols="50" name="bdesc"></textarea>
                    </div>

                    <div class="col-md-2">
                        <label for="inputZip" class="form-label">Image Name</label>
                        <input type="text" class="form-control" id="inputimage" name="bimage">
                    </div>
                    <div class="col-12">

                    </div>
                    <div class="col-12">
                        <input type="submit" class="btn btn-primary" name="addnewblog" value="Add">
